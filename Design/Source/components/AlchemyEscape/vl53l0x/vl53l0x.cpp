...
*/
/**************************************************************************/
boolean VL53L0X::begin(uint8_t i2c_addr, boolean debug, TwoWire *i2c,
...
*/
/**************************************************************************/
boolean VL53L0X::setAddress(uint8_t newAddr) {
  newAddr &= 0x7F;
...
*/
/**************************************************************************/
boolean VL53L0X::configSensor(VL53L0X_Sense_config_t vl_config) {
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::getSingleRangingMeasurement(
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::startMeasurement(boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::stopMeasurement(boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  if (Status == VL53L0X_ERROR_NONE) {
    if (debug) {
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::getLimitCheckCurrent(
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::setDeviceMode(VL53L0X_DeviceModes DeviceMode,
                                              boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  if (Status == VL53L0X_ERROR_NONE) {
    if (debug) {
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::setInterruptThresholds(
...
/**************************************************************************/
VL53L0X_Error
VL53L0X::getInterruptThresholds(FixPoint1616_t *pThresholdLow,
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::getDeviceMode(VL53L0X_DeviceModes *pDeviceMode,
                                              boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  if (Status == VL53L0X_ERROR_NONE) {
    if (debug) {
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::clearInterruptMask(boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  if (Status == VL53L0X_ERROR_NONE) {
    if (debug) {
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::setGpioConfig(
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::getGpioConfig(
...
*/
/**************************************************************************/
VL53L0X_Error VL53L0X::getRangingMeasurement(
    VL53L0X_RangingMeasurementData_t *RangingMeasurementData, boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  FixPoint1616_t LimitCheckCurrent;
...
uint8_t VL53L0X::readRangeStatus(void) { return _rangeStatus; }
...
boolean VL53L0X::startRange(void) {
...
boolean VL53L0X::isRangeComplete(void) {
...
boolean VL53L0X::waitRangeComplete(void) {
...
*/
/**************************************************************************/
boolean VL53L0X::startRangeContinuous(uint16_t period_ms) {
  /* This function will do a complete single ranging
   * Here we fix the mode! */
  // first lets set the device in SINGLE_Ranging mode
...
*/
/**************************************************************************/
void VL53L0X::stopRangeContinuous(void) {
...
/**************************************************************************/
boolean
VL53L0X::setMeasurementTimingBudgetMicroSeconds(uint32_t budget_us) {
...
*/
/**************************************************************************/
uint32_t VL53L0X::getMeasurementTimingBudgetMicroSeconds() {
  uint32_t budget_us;
  Status =
...
/**************************************************************************/
boolean
VL53L0X::setVcselPulsePeriod(VL53L0X_VcselPeriod VcselPeriodType,
...
/**************************************************************************/
uint8_t
VL53L0X::getVcselPulsePeriod(VL53L0X_VcselPeriod VcselPeriodType) {
  uint8_t cur_period;
 ...
 */
/**************************************************************************/
boolean VL53L0X::setLimitCheckEnable(uint16_t LimitCheckId,
 ...
 */
/**************************************************************************/
uint8_t VL53L0X::getLimitCheckEnable(uint16_t LimitCheckId) {
...
boolean VL53L0X::setLimitCheckValue(uint16_t LimitCheckId,
 ...
 */
/**************************************************************************/
FixPoint1616_t VL53L0X::getLimitCheckValue(uint16_t LimitCheckId) {
